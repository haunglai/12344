    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('filename', models.FileField(upload_to='', validators=[
                    django.core.validators.FileExtensionValidator(['xls', 'xlsx'], message='必须为xls或xlsx文件')])),
                ('file_type',
                 models.IntegerField(choices=[(1, '学生信息'), (2, '成绩信息')], default=1, help_text='file_type/文件类型',
                                     verbose_name='文件类型')),
